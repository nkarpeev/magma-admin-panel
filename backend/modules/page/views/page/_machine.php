...
<div class="home-update col-md-12">
    ...
    <div class="col-md-8">
        <?= $form->field($editModel, 'content_5')->textarea()->widget(TinyMce::className(), [
            'options'       => ['rows' => 10],
            'language'      => 'ru',
            'clientOptions' => [
                'plugins' => [
        ...
        ])->label('Текстовой описание 5'); ?>
    </div>
    <div class="col-md-4">
        <?= $form->field($uploadModel, 'image[image_5]')->fileInput();

        echo Html::img($editModel->getImage($editModel->image_5, Yii::getAlias(Yii::$app->params['contentImgUri'])),
            [
                'width' => '300px',
                'alt'   => $editModel->image_5
            ]);
        ?>
    </div>
</div>
